...
- (CALayer *)cl_scanQRCodePickLayer {
    ...
    CL_GET_METHOD_RETURN_OBJC(_cl_scanQRCodePickLayer);
    
    _cl_scanQRCodePickLayer = [[CALayer alloc] init];
...
- (CALayer *)cl_topLayer {
    ...
    CL_GET_METHOD_RETURN_OBJC(_cl_topLayer);
    
    _cl_topLayer = [[CALayer alloc] init];
...
- (CALayer *)cl_leftLayer {
    ...
    CL_GET_METHOD_RETURN_OBJC(_cl_leftLayer);
    
    _cl_leftLayer = [[CALayer alloc] init];
...
- (CALayer *)cl_bottomLayer {
    ...
    CL_GET_METHOD_RETURN_OBJC(_cl_bottomLayer);
    
    _cl_bottomLayer = [[CALayer alloc] init];
...
- (CALayer *)cl_rightLayer {
    ...
    CL_GET_METHOD_RETURN_OBJC(_cl_rightLayer);
    
    _cl_rightLayer = [[CALayer alloc] init];
